...
export default function About() {
  ...
  return (
    <section id="about">
      <Container
        className="overflow-hidden relative flex flex-col md:flex-row border gap-10 border-slate-400 dark:border-slate-50 rounded-[40px] p-10 my-10"
        ...
        <div className="md:w-1/2 w-full relative">
          ...
          <P className="text-7xl font-anekLatin">{t('subtitle')}</P>
        </div>
